...
def normalize_datetime_columns(df: pd.DataFrame, column_names:list[str]) ->  pd.DataFrame:
    logging.info(f"\n→ Convertendo colunas para datetime: {column_names}")
...
def data_transformations():
    ...
    logging.info("✓ Transformacoes concluídas\n")
    return df